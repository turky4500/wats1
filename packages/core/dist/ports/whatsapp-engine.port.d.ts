...
export type EngineEvent = 'qr' | 'authenticated' | 'ready' | 'disconnected' | 'message' | 'message_ack' | 'message_revoke' | 'group_update';
...
//# sourceMappingURL=whatsapp-engine.port.d.ts.map